...
//passes shipstate to fittness at end of sim 
using on_sim_end = void(*)(ShipState const&);
...
void play(control_t fnc, Level gameLevel, on_sim_end end_fnc, GameSpeed speed=GameSpeed::x1);

//GA algorithm
//train the genetic algorithm finally outputting a final memeber whos chromosomes represent the instructions for the ship
void learn(control_t fnc, Level gameLevel, GameSpeed speed = GameSpeed::x1);
